...
Dashboard assets are separated into `src/web/static/index.html`, `deck.css`, and `deck.js`; serve and package all three together. Keep CLI and web module entry points stable. See README for the package tree.
